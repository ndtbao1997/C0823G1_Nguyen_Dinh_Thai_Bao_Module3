...
UPDATE khach_hang kh JOIN task_18 ON kh.ma_khach_hang = task_18.ma_khach_hang 
SET kh.is_delete = 1;

UPDATE hop_dong hd JOIN task_18 ON hd.ma_khach_hang = task_18.ma_khach_hang
SET hd.is_delete = 1;
...
WHERE hd.ma_hop_dong IN (SELECT hd.ma_hop_dong FROM hop_dong hd JOIN task_18 ON task_18.ma_khach_hang = hd.ma_khach_hang);
