    ...
    <section>
        <div class="container flex">
            ...
            <div class="right col-6" style="position: relative">
                ...
                <a class="btn btn-primary" href="/viewing-schedule-admin?action=scheduleView&id=${apartment.getId()}" role="button" style="position: absolute;bottom: 35px;right: 30px;left: 40px">Đặt lịch xem</a>
            </div>
        </div>
    </section>
</c:if>
