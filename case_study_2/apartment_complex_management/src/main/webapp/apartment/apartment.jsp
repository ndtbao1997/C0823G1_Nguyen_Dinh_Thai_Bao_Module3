                    ...
                    <div class="card__container">
                        <article class="card__article">
                            ...
                            <div class="card__data">
                                ...
                                <a href="/apartment?action=floor1" class="card__button"> Tìm hiểu thêm
                                </a>
                            </div>
                        </article>
                        <div class="card-body ">
                    ...
                    <div class="card__container">
                        <article class="card__article">
                            ...
                            <div class="card__data">
                                ...
                                <span class="card__description"  > APARTMENT BUSINESS </span>
                                <a href="/apartment?action=floor2" class="card__button"> Tìm hiểu thêm
                                </a>
                            </div>
                        </article>
                        <div class="card-body ">
                    ...
                    <div class="card__container">
                        <article class="card__article">
                            ...
                            <div class="card__data">
                                ...
                                <span class="card__description"  > APARTMENT BUSINESS </span>
                                <a href="/apartment?action=floor3" class="card__button"> Tìm hiểu thêm
                                </a>
                            </div>
                        </article>
                        <div class="card-body ">
                    ...
                    <div class="card__container">
                        <article class="card__article">
                            ...
                            <div class="card__data">
                                ...
                                <span class="card__description"  > APARTMENT BUSINESS </span>
                                <a href="/apartment?action=floor4" class="card__button"> Tìm hiểu thêm
                                </a>
                            </div>
                        </article>
                        <div class="card-body ">
                    ...
                    <div class="card__container">
                        <article class="card__article">
                            ...
                            <div class="card__data">
                                ...
                                <span class="card__description"  > APARTMENT BUSINESS </span>
                                <a href="/apartment?action=floor5" class="card__button"> Tìm hiểu thêm
                                </a>
                            </div>
                        </article>
                        <div class="card-body ">
                    ...
                    <div class="card__container">
                        <article class="card__article">
                            ...
                            <div class="card__data">
                                ...
                                <span class="card__description"  > APARTMENT BUSINESS </span>
                                <a href="/apartment?action=floor6" class="card__button"> Tìm hiểu thêm
                                </a>
                            </div>
                        </article>
                        <div class="card-body ">
