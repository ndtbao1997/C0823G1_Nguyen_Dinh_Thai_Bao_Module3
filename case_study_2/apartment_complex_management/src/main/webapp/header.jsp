    ...
    <div class="container-fluid ">
        ...
        <div style="margin: 0 auto">
            <div class="collapse navbar-collapse ">
                <nav>
                    <ul>
                        <li><a href="/apartment" style="text-decoration: none; color: rgb(119,119,119);">Trang Chủ</a></li>
                        <li><a href="/apartment?action=apartment" style="text-decoration: none; color: rgb(119,119,119);">Căn hộ</a></li>
                        <li><a href="/apartment?action=facility" style="text-decoration: none; color: rgb(119,119,119);">Dịch vụ</a></li>
                        <li><a href="/apartment" style="text-decoration: none; color: rgb(119,119,119);">Thông báo</a></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="container px-0 py-3 mt-2">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                ...
                <div class="d-flex justify-content-center mt-2">
                    <h6 class=" px-2">Phòng Officetel</h6>
                </div>
            </div>
